...
def test_CreateTriangular():
    ...
    assert triangular.numParams == 2 + 7 
...
def test_CreateSingleEntryMap_1():
    ...
    assert single_entry_map.numParams == component.numParams
...
def test_CreateSigmoidMaps():
    ...
    assert sig.numParams == expected_num_coeffs
    ...
    assert sig_mset.numParams == mset_diag.Size() + mset_off.Size()
    ...
    assert sig_trimap.numParams == expected_num_coeffs